...
public class RelationManager {
    ...
    RelationDisplayDao relationDisplayDao;
    RelationDisplayTagDao relationDisplayTagDao;
     ...
     *
     * @param relationSaves the list of changes
     * @param poi           the poi
     */
    public void saveRelationSave(List<RelationSave> relationSaves, Poi poi) {
        for (RelationSave re : relationSaves) {
            re.setPoi(poi);
    ...
    public List<RelationDisplay> getValuesForBusLinesAutocompletion(String search) {
        return relationDisplayDao.queryByDatabaseIds(
                relationDisplayTagDao.queryForRelationTagNamesRelationsIDs(search)
        );
    }
